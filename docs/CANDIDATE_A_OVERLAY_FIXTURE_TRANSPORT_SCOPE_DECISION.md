...
[CANDIDATE_A_OBS_BROADCASTCHANNEL_HUMAN_QA_RESULT.md](CANDIDATE_A_OBS_BROADCASTCHANNEL_HUMAN_QA_RESULT.md) では、人間OBS Browser Source QA が PASS と記録された。
...
4. OBS BroadcastChannel human QA packet。
