...
Future task proposal only:

- If ChatGPT approves CL-002 later, inspect the intended OBS sizing contract first, then consider a small source change that preserves `/clock/?c=...` reproducibility while adding enough origin-side visual clearance for glow-heavy templates.
- No CL-002 CSS/layout fix was implemented in this pass.

## Remaining Deferred Items

- CL-002 implementation remains unapproved.
